...
if TYPE_CHECKING:
    from ..models.system_config_backups_dto import SystemConfigBackupsDto
    ...
    from ..models.system_config_machine_learning_dto import (
    ...
    from ..models.system_config_new_version_check_dto import (
        SystemConfigNewVersionCheckDto,
    )
    from ..models.system_config_nightly_tasks_dto import SystemConfigNightlyTasksDto
    ...
    from ..models.system_config_reverse_geocoding_dto import (
        SystemConfigReverseGeocodingDto,
    )
    from ..models.system_config_server_dto import SystemConfigServerDto
    from ..models.system_config_storage_template_dto import (
        SystemConfigStorageTemplateDto,
    )
    from ..models.system_config_templates_dto import SystemConfigTemplatesDto
...
class SystemConfigDto:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        nightly_tasks = self.nightly_tasks.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.system_config_nightly_tasks_dto import SystemConfigNightlyTasksDto
        from ..models.system_config_notifications_dto import (
            SystemConfigNotificationsDto,
        )
        from ..models.system_config_o_auth_dto import SystemConfigOAuthDto
        from ..models.system_config_password_login_dto import (
        ...
        d = dict(src_dict)
        backup = SystemConfigBackupsDto.from_dict(d.pop("backup"))
        ...
        nightly_tasks = SystemConfigNightlyTasksDto.from_dict(d.pop("nightlyTasks"))
        ...
        templates = SystemConfigTemplatesDto.from_dict(d.pop("templates"))
