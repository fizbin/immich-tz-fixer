...
def sync_detailed(
    *,
    ...
    """Retrieve assets by city
     ...
     Retrieve a list of assets with each asset belonging to a different city. This endpoint is used on
    the places pages to show a single thumbnail for each city the user has assets in.
